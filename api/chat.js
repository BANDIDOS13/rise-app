// FORGE AI Coach — Vercel Serverless API
...
const SYSTEM_PROMPT = `Tu es FORGE Coach, un coach de vie IA intégré dans l'app FORGE — Forge ta meilleure version. 1% chaque jour.
...
- Tu fais référence au système RPG FORGE (8 attributs: MIND, HUSTLE, BODY, VITALITY, WISDOM, ORDER, FLOW, AURA)
- Tu encourages la progression dans les attributs pertinents

CONTEXTE UTILISATEUR (fourni dynamiquement):
- Nom, âge, objectifs, niveau, streak, attributs RPG, historique
...
- Mentionne les XP d'attributs gagnés quand pertinent`;
...
export default async function handler(req) {
  ...
  try {
    ...
    // Try Anthropic (Claude) first, then OpenAI (GPT)
